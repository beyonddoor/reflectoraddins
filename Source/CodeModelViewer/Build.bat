...
"%FrameworkPath%\csc.exe" /nologo /target:library /out:"..\..\Build\Reflector.CodeModelViewer.dll" /reference:"..\..\Build\Reflector.exe" *.cs /res:Icon.png,Reflector.CodeModelViewer.Icon.png
